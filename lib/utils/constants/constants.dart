...
const appName = "MyoQuiz";
const packageName = "com.medical.exam";
...
const supportedLocales = ['en', 'hi', 'ar', 'ur', "en-GB"];
//
const defaultLanguageCode = 'en';

//Enter 2 Letter ISO Code of country
//It will be use for phone auth.
const initialSelectedCountryCode = 'US';
...
const databaseUrl = "https://pharmflu.waseetcash.com";
